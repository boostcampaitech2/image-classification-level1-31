...
if __name__ == '__main__':
    ...
    parser.add_argument('--dataset', type=str, default='AgeDataset', help='dataset augmentation type (default: MaskSplitByProfileDataset)')
    parser.add_argument('--model', type=str, default='agemodel', help='model type (default: MultiModel)')
